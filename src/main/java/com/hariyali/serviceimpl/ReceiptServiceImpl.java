...
//		document.add(signatureImage);
			...
			Paragraph additionalText = new Paragraph(
					"Income Tax Exemption U/S 80-G Granted Vide Certificate Number AAATK0315QF2021401 dated 28th May 2021 containing Approval Number AAATK0315QF20214 valid from 01st April 2021 to 31st March 2026. PAN - AAATK0315Q");
...
//		document.add(signatureImage);
			...
			document.add(line);
			Paragraph additionalText = new Paragraph(
					"Income Tax Exemption U/S 80-G Granted Vide Certificate Number AAATK0315QF2021401 dated 28th May 2021 containing Approval Number AAATK0315QF20214 valid from 01st April 2021 to 31st March 2026. PAN - "+pancard);
			additionalText.setAlignment(Element.ALIGN_LEFT);
			document.add(additionalText);
			Paragraph note = new Paragraph("*Note-\n"
					+ "Kindly note that K.C. Mahindra Education Trust shall not be responsible for the verification of the donor's PAN details as well as for the denial of deduction u/s 80G of the Income Tax Act, 1961 for furnishing an incorrect PAN.",
